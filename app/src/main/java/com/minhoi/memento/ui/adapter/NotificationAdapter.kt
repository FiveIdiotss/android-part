...
class NotificationAdapter(
    private val onItemClickListener: (NotificationListDto) -> Unit,
    private val onDeleteClickListener: (Long) -> Unit,
) : PagingDataAdapter<NotificationListDto, NotificationAdapter.ViewHolder>(DiffCallback()) {
                ...
                NotificationListType.APPLY -> {
                    binding.apply {
                        ...
                        notificationTitle.text =
                            String.format(item.type.message, item.senderName, item.title)
